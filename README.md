...
└── tests/                   # 188 tests hors ligne (Python + Node)
```
...
Vérifié sur une instance vierge : 188 tests hors ligne, isolation entre deux comptes,
...
Les 180 tests Python et 8 tests JavaScript sont hors ligne et n'utilisent aucune clé API. Ils
