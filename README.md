...
└── tests/                   # 185 tests hors ligne (Python + Node)
```
...
Vérifié sur une instance vierge : 185 tests hors ligne, isolation entre deux comptes,
...
Les 177 tests Python et 8 tests JavaScript sont hors ligne et n'utilisent aucune clé API. Ils
