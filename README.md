...
└── tests/                   # 191 tests hors ligne (Python + Node)
```
...
Vérifié sur une instance vierge : 191 tests hors ligne, isolation entre deux comptes,
...
Les 183 tests Python et 8 tests JavaScript sont hors ligne et n'utilisent aucune clé API. Ils
