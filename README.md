...
└── tests/                   # 193 tests hors ligne (Python + Node)
```
...
Vérifié sur une instance vierge : 193 tests hors ligne, isolation entre deux comptes,
...
Les 183 tests Python et 10 tests JavaScript sont hors ligne et n'utilisent aucune clé API. Ils
