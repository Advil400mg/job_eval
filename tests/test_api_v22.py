...
from app import config, pipeline, security, store  # noqa: E402
...
class ApiV22(unittest.TestCase):
    def setUp(self):
        ...
        (self.root / "PROFILE.json").write_text(json.dumps(profile), encoding="utf-8")
        (self.root / "CV_MASTER.json").write_text(json.dumps(master), encoding="utf-8")
